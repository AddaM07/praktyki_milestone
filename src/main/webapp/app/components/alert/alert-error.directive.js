(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope, $translate) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('jhipsterProjectApp.httpError', function (event, httpResponse) {
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-jhipsterProjectApp-error');
                var entityKey = httpResponse.headers('X-jhipsterProjectApp-params');
                if (errorHeader) {
                    ...
                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                        ...
                        var fieldName = $translate.instant('jhipsterProjectApp.' + fieldError.objectName + '.' + convertedField);
